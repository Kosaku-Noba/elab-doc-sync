...
| eLabFTW → ローカルに取得 | `esync pull --id 42` |
| 複数 ID を一括取得 | `esync pull --id 42 --id 43` |
...
| `--id を指定してください` | `esync pull --id <番号>` で ID を指定 |

## もっと詳しく

- 全コマンドの詳細: [CLI リファレンス](https://github.com/Kosaku-Noba/elab-doc-sync/blob/develop/docs/05_CLI_REFERENCE.md)
- 設定ファイルの全オプション: [設定ファイル仕様](https://github.com/Kosaku-Noba/elab-doc-sync/blob/develop/docs/04_CONFIGURATION.md)
